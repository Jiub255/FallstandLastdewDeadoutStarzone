...
---------------------------------------------------------------------------------------------------------
    ...
    FINISH BUILD MODE, THEN MAKE SCAVENGING SCENE AND MAKE A TRUE HOME SCENE (NO LOOTING)
        ...
        FIX: Clicking on UI places building behind it in world space.
    ...
    FINISH CAMERA CONTROLLER
        ...
        GET RID OF MOUSE DRAG MOVEMENT?
            Already have keyboard and edge scrolling, plus drag movement is too fast and causing issues,
                plus then right click can be used for something else. 
        ...
        FIX: Dragging off edge causes camera to jump far off edge. 
