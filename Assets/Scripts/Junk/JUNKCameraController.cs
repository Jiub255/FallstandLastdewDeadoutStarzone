...
public class JUNKCameraController : MonoBehaviour
{
/*    [SerializeField]
...
//#endif
    ...
    private void Start()
    {
        S.I.InputManager.mouseWheelAction.performed += Zoom;
    }
    ...
    {
        float wheelMovement = S.I.InputManager.mouseWheelAction.ReadValue<float>();
    ...
    private void LateUpdate()
    {
        if (!UIManager.gamePaused)
        {
            ...
            if (!S.I.InputManager.mouseWheelAction.WasPerformedThisFrame())
            {
                //--------------------------------------------------------
                // GET CAMERA VECTORS
                ...
                // Get input
                Vector2 movement = 
                    S.I.InputManager.moveCameraAction.ReadValue<Vector2>();
                ...
                if (S.I.InputManager.mouseRightAction.WasPressedThisFrame()*//* &&
                ...
                if (clickedGround)
                {
                    if (S.I.InputManager.mouseRightAction.IsPressed() && 
                        !S.I.InputManager.rotateCameraAction.IsPressed())
                    {
                ...
                if (S.I.InputManager.rotateCameraAction.IsPressed())
                {
                    float deltaX = 
                        S.I.InputManager.mouseDeltaAction.ReadValue<Vector2>().x * 
                        rotationSpeed;
                    ...
                    float deltaY =
                        S.I.InputManager.mouseDeltaAction.ReadValue<Vector2>().y *
                        rotationSpeed;
