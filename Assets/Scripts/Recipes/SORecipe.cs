...
public abstract class SORecipe : ScriptableObject
{
	...
	private List<StatRequirement> _minSinglePCStatRequirements;
	...
	public List<StatRequirement> MinSinglePCStatRequirements { get { return _minSinglePCStatRequirements;} }
